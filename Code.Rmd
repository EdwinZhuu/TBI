...
for (i in shapiro_control_index_norm){
  t.test(WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "baseline" & WMF_skeleton_ROI_label$group != "test"),i],
         WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "6_week" & WMF_skeleton_ROI_label$group != "test"),i], 
