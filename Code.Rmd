...
temp = names(which(table(WMF_skeleton_ROI_label$`CAN-TBI Study ID (Screening/Hospital data)`) == 1))
WMF_skeleton_ROI_label = WMF_skeleton_ROI_label[!(WMF_skeleton_ROI_label$`CAN-TBI Study ID (Screening/Hospital data)` %in% temp),]
...
for (i in shapiro_control_index_norm){
  print(length(WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "baseline" & WMF_skeleton_ROI_label$group == "control"),i]))
  print(length(WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "6_week" & WMF_skeleton_ROI_label$group == "control"),i]))
}

for (i in shapiro_control_index_norm){
  t.test(WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "baseline" & WMF_skeleton_ROI_label$group == "control"),i],
         WMF_skeleton_ROI_label[which(WMF_skeleton_ROI_label$type == "6_week" & WMF_skeleton_ROI_label$group == "control"),i], 
